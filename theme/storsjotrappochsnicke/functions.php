<?php
/**
 * AB Storsjö Trapp & Snickerifabrik theme functions.
 *
 * Kept short on purpose. Design lives in theme.json, markup in templates and patterns.
 * Lead capture lives in the "AB Storsjö Trapp & Snickerifabrik Leads" plugin, so leads survive a theme change.
 *
...
add_action(
	'wp_enqueue_scripts',
	function () {
		wp_enqueue_style( 'storsjotrappochsnicke', get_stylesheet_uri(), array(), wp_get_theme()->get( 'Version' ) );
	}
);
add_action(
	'after_setup_theme',
...
add_action(
	'init',
	function () {
		register_block_style( 'core/paragraph', array( 'name' => 'eyebrow', 'label' => __( 'Eyebrow label', 'storsjotrappochsnicke' ) ) );
		register_block_style( 'core/list', array( 'name' => 'checklist', 'label' => __( 'Tick list', 'storsjotrappochsnicke' ) ) );

		register_block_pattern_category( 'storsjotrappochsnicke-sections', array( 'label' => __( 'AB Storsjö Trapp & Snickerifabrik sections', 'storsjotrappochsnicke' ) ) );
		register_block_pattern_category( 'storsjotrappochsnicke-pages', array( 'label' => __( 'AB Storsjö Trapp & Snickerifabrik page layouts', 'storsjotrappochsnicke' ) ) );
	}
);
