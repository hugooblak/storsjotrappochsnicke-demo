<?php
/**
 * Demo site setup for AB Storsjö Trapp & Snickerifabrik.
 *
 ...
 *
 * @package AB Storsjö Trapp & Snickerifabrik
 */
 ...
 * Site settings
 * ----------------------------------------------------------------------- */
update_option( 'blogname', 'AB Storsjö Trapp & Snickerifabrik' );
...
$home = nps_page(
	...
	nps_pattern( 'storsjotrappochsnicke/page-home' ),
...
nps_page(
	'takomlaggning',
	'Takomläggning',
	nps_pattern( 'storsjotrappochsnicke/page-replacement' ),
...
nps_page(
	...
	nps_pattern( 'storsjotrappochsnicke/page-storm' ),
...
$quote = nps_page(
	'offert',
	'Boka besiktning',
	nps_pattern( 'storsjotrappochsnicke/quote-funnel' ),
...
$thanks = nps_page(
	'tack',
	'Tack',
	nps_pattern( 'storsjotrappochsnicke/thank-you' ),
...
<p class="has-large-font-size">AB Storsjö Trapp & Snickerifabrik är ett familjeföretag från Sollentuna. Vi startade 1996 med en bil och en regel vi fortfarande håller oss till: priset vi skriver ner är priset du betalar.</p>
<!-- /wp:paragraph -->
...
<!-- /wp:list -->
HTML;
nps_page( 'om-oss', 'Om AB Storsjö Trapp & Snickerifabrik', $about_content . "\n\n" . nps_pattern( 'storsjotrappochsnicke/cta-inline' ), 'Familjeägt takföretag i norra Stockholm sedan 1996. Egna montörer, fasta priser skriftligt och 10 års garanti.' );
...
nps_page( 'vanliga-fragor', 'Vanliga frågor', $faq_content . "\n\n" . nps_pattern( 'storsjotrappochsnicke/cta-inline' ), 'Svar om offert, pris, ROT-avdrag, hur lång tid en takomläggning tar och vad garantin täcker.' );
...
<!-- /wp:paragraph -->
HTML;
$privacy = nps_page( 'integritetspolicy', 'Integritetspolicy', $privacy_content, 'Så använder AB Storsjö Trapp & Snickerifabrik uppgifterna du skickar med offertformuläret.' );
...
nps_log( 'AB Storsjö Trapp & Snickerifabrik demo ready.' );
