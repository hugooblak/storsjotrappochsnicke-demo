...
add_filter(
	...
	function ( $exporters ) {
		$exporters['storsjotrappochsnicke-leads'] = array(
			'exporter_friendly_name' => __( 'Quote requests', 'storsjotrappochsnicke-leads' ),
			'callback'               => function ( $email ) {
				$items = array();
				foreach ( npl_leads_by_email( $email ) as $lead ) {
					$data = array( array( 'name' => __( 'Received', 'storsjotrappochsnicke-leads' ), 'value' => $lead->post_date ) );
					...
					$items[] = array(
						'group_id'    => 'storsjotrappochsnicke-leads',
						'group_label' => __( 'Quote requests', 'storsjotrappochsnicke-leads' ),
...
add_filter(
	...
	function ( $erasers ) {
		$erasers['storsjotrappochsnicke-leads'] = array(
			'eraser_friendly_name' => __( 'Quote requests', 'storsjotrappochsnicke-leads' ),
			'callback'             => function ( $email ) {
				$removed = false;
				foreach ( npl_leads_by_email( $email ) as $lead ) {
